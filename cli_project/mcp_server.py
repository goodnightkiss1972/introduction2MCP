...
def format_document(
    ...
    Feel free to add in examples, diagrams, or other markdown features to make the document more readable and informative.
    Use the 'edit_document' tool to edit the document.
    After the document is reformatted, return a message with the content "Document reformatted successfully."
    """
